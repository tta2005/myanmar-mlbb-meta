...
def update_web():
    # နမူနာ Live Data (နောက်အဆင့်တွင် တကယ့် URL နှင့် ချိတ်ပါမည်)
    live_data = [
        {"name": "Akai", "wr": "52.8%", "img": "https://img.mobilelegends.com/group1/M00/00/01/Cq8JEmL_W_uAP5YRAAAd-L98mXo358.png", "tier": "S"},
        {"name": "Minsitthar", "wr": "51.4%", "img": "https://img.mobilelegends.com/group1/M00/00/01/Cq8JEmL_W_uAP5YRAAAd-L98mXo358.png", "tier": "A"}
    ]
    ...
    try:
        ...
        print(f"Error: Marker not found. {e}")
